...
vectorizer = CountVectorizer(max_df = 0.50, ngram_range=(1, 2))
tf_transformer = TfidfTransformer()

##pprint.pprint((vectorizer.fit(features_train)).vocabulary_)
#pprint.pprint((vectorizer.fit(features_train)).get_params())

features_train = vectorizer.fit_transform(features_train)
features_train = tf_transformer.fit_transform(features_train)
